...
/*if(playersNumber west < 0) exitWith { hint "Der Geldtransport war noch nicht da!"};//This line has been commented out, but can be set so that you can limit the ability to robb based on cops online.*/
...
if (currentWeapon _robber == "") exitWith { hint "Du bekommste ohne wirklichen Meinungsverstärker keine Kohle!" };//is he trying to rob without a weapon? Lets taunt him a bit!
