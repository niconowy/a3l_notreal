...
[[1,format["%1 wurde auf die Fahndungsliste hinzugefügt.",_unit getVariable["realname",name _unit],_amount,getPlayerUID _unit]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
