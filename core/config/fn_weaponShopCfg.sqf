			...
			case (__GETC__(life_mediclevel) == 2):
			{
				["Sanitäter",
					[
						...
						["cse_quikclot",nil,50],
						["cse_splint",nil,50], // Gibt keine Brüche
			...
			case (__GETC__(life_mediclevel) == 4):
			{
				["Arzt",
					[
						...
						["cse_opa",nil,50], // Funktioniert nicht
						["cse_bandageElastic",nil,50],
						["cse_liquidSkin",nil,50], // Gibt keine Verbrennungen
						["cse_chestseal",nil,50],
						["cse_surgical_kit",nil,50]
					]
				];
			...
			default {
				["IPD Shop",
					[
						...
						["tf_anprc148jem_13","Kurzstreckenfunk",2500],
						["tf_anprc155","Langstreckenfunk",2500],
