...
*/			
	...
	case 3:
	{
		[
			...
			["k_cut_1","Sinister Sons",1000],
			["k_cut_2","Gold Gunners",1000],
			["k_cut_3","Sons of Anarchy Member",1000],
			["k_cut_4","Sons of Anarchy President",1000],
			["k_cut_5","Sons of Outlaws",1000],
			["Jamie_Sheriff1","Große FBI Weste",750],
			["Jamie_Rebell",nil,1050]
		];
	};
